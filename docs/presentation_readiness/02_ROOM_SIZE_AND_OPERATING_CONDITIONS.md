...
> A mobile-based smart attendance system designed for classroom proximity verification using Acoustic and BLE signals, with stronger suitability for small to medium controlled classroom environments and possible extension to larger rooms through BLE beacons or Wi-Fi support.
...
- Useful as a short-range proximity/coprotection signal.
...
- Can work while students are not extremely close to the lecturer phone.
...
| --- | --- | --- | --- | --- |
| Small tutorial room | Up to about 7 m x 7 m | 10-30 students | Good for demo and controlled use | Acoustic + BLE, lecturer device near the class center |
| Laboratory or seminar room | About 7 m x 10 m | 20-50 students | Good to moderate | BLE primary, acoustic secondary |
| Medium classroom | About 8 m x 12 m | 40-80 students | Moderate without extra infrastructure | BLE primary, Wi-Fi support recommended, acoustic optional |
| Large lecture hall | Above 12 m x 12 m | 80+ students | Limited without infrastructure | Fixed BLE beacons and/or classroom Wi-Fi verification recommended |
...
| --- | --- | --- |
| Acoustic phone-to-phone | About 0.3 m to 1.0 m in noisy conditions | Close-range proof, small room demo, secondary proximity evidence |
| Acoustic in quiet room | May reach above 1 m depending on device hardware | Controlled demo and future optimization tests |
| BLE phone-to-phone | About 1 m to 5 m depending on phone hardware and permissions | Primary classroom proximity signal for current prototype |
...
| Wi-Fi classroom network | Room/building-level coverage depending on router/AP | Additional network-presence verification, not exact proximity |
...
| Near-term pilot | Small classroom, about 10-30 students |
| Medium-class pilot | Dedicated router/AP plus BLE as primary signal |
| Large-class deployment | Fixed BLE beacons and/or managed classroom Wi-Fi |
...
2. Classroom Wi-Fi verification.
...
| Medium room | 1 dedicated Wi-Fi router/AP and possibly 2-4 BLE beacons |
| Large lecture hall | 1-2 Wi-Fi access points and about 4-8 BLE beacons depending on layout |
...
> The current implementation demonstrates Acoustic and BLE-based classroom proximity verification on Android devices. Acoustic verification is more sensitive to range and noise, while BLE is more practical for wider classroom coverage. For larger rooms, the system can be extended using fixed BLE beacons or Wi-Fi-based classroom verification.
