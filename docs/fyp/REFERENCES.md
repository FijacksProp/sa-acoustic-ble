...
Android Developers. (n.d.). *Bluetooth permissions*. Retrieved May 8, 2026, from https://developer.android.com/develop/connectivity/bluetooth/bt-permissions
...
Wahab, M. H. A., Kadir, H. A., Yusof, M. N. M., Sanudin, R., & Tomari, M. R. (2009, July 8-9). *Class attendance system using active RFID: A review*. Proceedings of the 2nd Seminar on Engineering and Information Technology, Kota Kinabalu, Sabah, Malaysia. https://www.researchgate.net/publication/272421510_Class_Attendance_System_using_Active_RFID_A_Review
